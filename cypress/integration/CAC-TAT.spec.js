...
describe('Central de Atendimento ao Cliente TAT', function() {
  ...
  it('campo telefone continua vazio quando preenche com valor não-numérico', function() {
    cy.get('#phone')
      .type('abcdsceassa')
      .should('have.value', '')
  })
  ...
  it('preenche e limpa os campos nome, sobrenome, email e telefone', function() {
    cy.get('#firstName')
      .type('Rogerio')
      .should('have.value', 'Rogerio')
      .clear()
      .should('have.value', '')
    cy.get('#lastName')
      .type('Portilho')
      .should('have.value', 'Portilho')
      .clear()
      .should('have.value', '')
    cy.get('#email')
      .type('rogerportilhoart@gmail.com')
      .should('have.value', 'rogerportilhoart@gmail.com')
      .clear()
      .should('have.value', '')
  ...
  it('selecione um produto (Blog) pelo seu índice', function() {
    cy.get('#product')
      .select(1)
  ...
  //Simulação de arrastar o arquivo para o campo, porém isso não mostra na tela, mas esta sendo realizado por baixo
